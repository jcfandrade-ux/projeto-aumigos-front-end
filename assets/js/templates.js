...
const Templates = {
  ...
  register() {
    ...
    this.templates.index = `
      ...
      <section>
        <h2>Nossa Equipe</h2>
        <img src="../images/equipe.jpg" alt="Equipe da ONG Aumigos!" width="400">
      </section>
    ...
    this.templates.projetos = `
      <section>
        ...
        <img src="../images/projeto-patas.jpg" alt="Resgate animal realizado pela ONG Aumigos!" width="300">
      </section>

      <section>
        <h2>Projeto Educação com Patas</h2>
        <p>Leva palestras sobre respeito e responsabilidade aos lares e escolas.</p>
        <img src="../images/projeto-educacao.jpg" alt="Palestra educativa promovida pela ONG Aumigos!" width="300">
      </section>
      ...
      <section>
        ...
        <video controls src="../images/video-aumigos.mp4" alt="Vídeo dos projetos da ONG Aumigos!" width="400"></video>
      </section>
    `;

    // Template da página de cadastro (cadastro)
    this.templates.cadastro = `
      <img src="../images/cachorro-oculos.jpg" alt="Cachorro com óculos preenchendo formulário" width="300">
